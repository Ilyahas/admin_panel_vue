module.exports = function(app, path, express, passport) {
    ...
    app.use('/admin', authCheck.isLoggedIn, express.static(path.join(newdir_ + '/Client/admin/dist')));
    app.use('/login', authCheck.isAuthorized, express.static(path.join(newdir_ + '/Client/login/dist')));
