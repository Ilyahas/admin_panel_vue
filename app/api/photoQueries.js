module.exports = {
    ...
    'updatePhotoSectionWithImg': 'UPDATE photo_sections SET section_name=$1::text, img_name=$2::text, img_data=$3::text WHERE id_photo_sections = $4::integer',
    ...
    'addNewPhoto': 'INSERT INTO photos (photo_title, img_name, img_data, id_photo_sections) VALUES ($1::text, $2::text, $3::text, $4::integer)',
