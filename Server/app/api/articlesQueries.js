module.exports = {
    ...
    'getTopArticles': 'SELECT * FROM admin_panel.Articles order by idArticles DESC LIMIT :topNumber OFFSET :fromNumber',
    ...
    'updateArticle': 'UPDATE admin_panel.Articles SET Title = :title, Text = :text WHERE idArticles = :articleId',
